...
namespace App10
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            var secondBtn = FindViewById<Button>(Resource.Id.SecondBtn);
            secondBtn.Click += delegate
            {
                Log.Debug(GetType().FullName, "Starting second activity");
                var secondA = new Intent(this, typeof(SecondActivity));
                secondA.PutExtra("Data key", counterClick.ToString());
                StartActivity(secondA);
            };
        }
